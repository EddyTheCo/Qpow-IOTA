...
signals:
		...
		/*!
		  \class nonceFinder
		  \brief The nonceFinder class calculates the nonce in order to fulfill PoW following the [TIP](https://github.com/iotaledger/tips/blob/main/tips/TIP-0012/tip-0012.md)

		  A nonceFinder calculates a quint64 value (nonce) needed to get certain pow score from a message.
		  A more detailed explanation can be found on the [TIP](https://github.com/iotaledger/tips/blob/main/tips/TIP-0012/tip-0012.md)
